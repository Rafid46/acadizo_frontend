...
const ActivityCard = ({ allActivities, loading }: any) => {
  ...
  // Get total students in the current user's academy
  const getTotalStudentsInAcademy = () => {
    const currentUserEmail = currentUser?.email;
    const joinedAcademyDetails = academyLists?.find((item: any) =>
      item?.academyMembers?.some(
        (member: any) => member?.email === currentUserEmail
    ...
    return (
      joinedAcademyDetails?.academyMembers?.filter(
      ...
      <>
        {loading ? (
          ...
          <>
            ...
            {/* card */}
            <div className="rounded-2xl pb-2 mt-4">
              <AnimatePresence>
                  ...
                  >
                    ...
                    >
                      <div className="">
                        ...
                        <AnsweredPieChart
                          activity={activity}
                          totalStudents={totalStudentsInAcademy}
                        />
