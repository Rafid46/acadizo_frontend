...
import easy from "../../../assets/images/easier.jpg";
              ...
              return (
                ...
                >
                  <div className="card__header flex justify-between gap-3 relative text-white">
                    <span
                      className={`card__label text-base font-semibold ${
                        card.label === "Efficiency" && "text-zinc-900"
                      }`}
                    >
                      {card.label}
                    </span>
                  ...
                  <div className="card__content flex flex-col  text-white">
                    ...
                    <h3
                      className={`z-10 card__title font-normal text-[12px] m-0 mb-1 ${
